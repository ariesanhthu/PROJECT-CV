...
\begin{frame}{Kết luận: các điểm đã chốt}
  \begin{block}{Đóng góp đã hoàn thành}
    \begin{itemize}
      ...
      \item \textbf{Baseline}: BiSeNet được chuẩn hóa và đánh giá trên \textbf{FoodSeg103 nguyên thủy (103 lớp)}
...
\begin{frame}{Kết luận: hướng tiếp theo}
  \begin{alertblock}{Hướng tiếp theo}
    Kiểm tra hệ thống 3 module đề xuất: \textbf{Texture Branch + Relation GNN + Boundary Supervision} trên \texttt{FoodSeg103} nguyên thủy
  \end{alertblock}
  \vspace{0.2em}
