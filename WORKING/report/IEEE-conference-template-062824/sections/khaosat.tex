...
Phần này chỉ tập trung vào ba câu hỏi trực tiếp dẫn đến đề tài: FoodSeg103 khó ở đâu, các mô hình segmentation nhẹ đang đánh đổi điều gì, và các cơ chế tăng cường chi tiết cục bộ có thật sự gợi mở một hướng phù hợp cho dữ liệu thực phẩm hay không.

\subsection{Fine-grained food segmentation và benchmark FoodSeg103}

Phân đoạn ảnh thực phẩm ở mức nguyên liệu khó hơn rõ rệt so với semantic segmentation tổng quát vì nhiều lớp có hình dạng tổng thể gần nhau nhưng khác nhau ở texture, trạng thái bề mặt và chất lượng biên \cite{benchmarkfood}. Trong cùng một ảnh, các nguyên liệu thường chồng lấp, bị che khuất một phần và có ranh giới yếu sau chế biến. Vì vậy, local detail đóng vai trò trực tiếp trong việc phân biệt lớp, thay vì chỉ là tín hiệu bổ trợ.
...
Do đó, bài hiện tại không cố tuyên bố một mô-đun texture-aware mới đã vượt trội hơn state of the art. Thay vào đó, nghiên cứu tập trung vào bước nền: phân tích dữ liệu, tái cân bằng không gian nhãn và chuẩn hóa baseline BiSeNet trên \texttt{FoodSeg103\_rebalanced}. Đây là điểm tựa cần thiết để các nghiên cứu tiếp theo có thể đánh giá công bằng các cải tiến texture-aware hoặc boundary-aware dưới cùng một điều kiện thực nghiệm.
